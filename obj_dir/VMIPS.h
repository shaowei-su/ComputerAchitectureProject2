...
VL_MODULE(VMIPS) {
  ...
  public:
    ...
    static void	_settle__TOP__11(VMIPS__Syms* __restrict vlSymsp);
    static void	_settle__TOP__6(VMIPS__Syms* __restrict vlSymsp);
    static void	_settle__TOP__7(VMIPS__Syms* __restrict vlSymsp);
    static void	_settle__TOP__9(VMIPS__Syms* __restrict vlSymsp);
} VL_ATTR_ALIGNED(128);
